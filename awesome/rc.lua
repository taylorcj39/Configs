...
globalkeys = gears.table.join(
    ...
    --Firefox
    awful.key({ modkey }, "b", function () awful.spawn("firefox", {floating=false}) end,
              {description = "Open a browser (firefox)", group = "launcher"}),

    --Nautilus
    awful.key({ modkey, "Shift" }, "n", function () awful.spawn("nautilus", {floating=false}) end,
              {description = "Open nautilus file explorer", group = "launcher"}),
